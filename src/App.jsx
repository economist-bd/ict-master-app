...
const authorInfo = {
  ...
  title: "লেকচারার এন্ড ওয়েব ডেভলপার",
  experience: "১০ বছরের অভিজ্ঞতাসম্পন্ন",
  institution: "জিয়াউদ্দিন স্কুল এন্ড কলেজ,কিশোরগঞ্জ",
  bio: "শিক্ষার্থীদের সর্বোচ্চ সাফল্যের জন্য প্রশ্ন বিশ্লেষণের মাধ্যমে এই সাজেশনটি তৈরি করা হয়েছে।"
};
